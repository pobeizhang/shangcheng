...
<body>
	...
	<div class='create-main'>
		<p class='create-right'>
			已有账号i？
			<a href="{{U('Home/Login/login')}}">快速登录</a>
		</p>
		...
		<div class='create-content'>
			<ul class='email-create mail'>
				<form action="{{U('Home/Register/register')}}" id='fm' method="post">
					<li class='prz'>
						<label>邮箱</label>
					...
					<li>
						...
						<div class='input-warp'>
							...
							<img src="{{U('Home/Yzm/codeshow')}}" alt="验证码" class='yzmimg' width='72' height='36' />
