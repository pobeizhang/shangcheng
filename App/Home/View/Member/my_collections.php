		...
		<div id="main">
			<div class="myls-left">
				<div class="myls-title">
					...
					<a class="select" href="/account/collections/">我的收藏</a>
				...
				<ul class="fr">
				    ...
				    <li class="nobg"><a href="{{U('Home/Member/my_collections_shop')}}"><span>商家（0）</span></a><em></em></li>
					<li class="selcet"><a href="/account/collections/"><span>团购（0）</span></a><em></em></li>
                </ul>
			</h3>
					<div class="myls-lct">
						<div class="subsort subsort2">
							<a class="nobg select" href="/account/collections/list/online/">进行中(0)</a>
							<span>|</span>
							<a href="/account/collections/list/offline/">已结束(0)</a>
						</div>
						<div class="myls-kong">
							<span>您还没有收藏过商品，在详情页点击"<em>收藏单品</em>"即可</span>
							<img src="http://d2.lashouimg.com/static/img/myls/myla-kong3.jpg" height="348" width="610">
						</div>
					</div>
				</div>
				<div class="find-list collect-bot">
					<h4>您可能对以下团购感兴趣：</h4>
					<ul>
						<li>
							<a class="find-listimg" href="http://beijing.lashou.com/deal/7838892.html?zf=1" target="_blank"><img src="http://d1.lashouimg.com/cms/M00/00/9B/CqgBHlJ5-MeASqyeAADphXzxSCk826-220x140.jpg" alt="健康体检1人次，全程时长约为2小时" height="127" width="200"></a>
							<h5><a href="http://beijing.lashou.com/deal/7838892.html?zf=1" target="_blank">健康体检1人次，全程时长约为2小时</a></h5>
							<div class="find-listinfo"><a href="http://beijing.lashou.com/deal/7838892.html?zf=1" target="_blank">去看看</a><span>¥338</span>市场价 ¥<del>1205</del></div>
						</li>
						<li>
							<a class="find-listimg" href="http://beijing.lashou.com/deal/7868767.html?zf=1" target="_blank"><img src="http://d2.lashouimg.com/cms/M00/03/D4/CqgBHlKz6ASANckNAAD6rQA-Qj0533-220x140.jpg" alt="欢唱套系，不限时段，2张券起唱" height="127" width="200"></a>
							<h5><a href="http://beijing.lashou.com/deal/7868767.html?zf=1" target="_blank">欢唱套系，不限时段，2张券起唱</a></h5>
							<div class="find-listinfo"><a href="http://beijing.lashou.com/deal/7868767.html?zf=1" target="_blank">去看看</a><span>¥25</span>市场价 ¥<del>417</del></div>
						</li>
						<li>
							<a class="find-listimg" href="http://beijing.lashou.com/deal/8791871.html?zf=1" target="_blank"><img src="http://d1.lashouimg.com/cms/M00/6B/19/CqgBJlQZLByAJ1NxAAE8qTBrgFU619-220x140.jpg" alt="现金抵用1次，全场通用，可累计使用" height="127" width="200"></a>
							<h5><a href="http://beijing.lashou.com/deal/8791871.html?zf=1" target="_blank">现金抵用1次，全场通用，可累计使用</a></h5>
							<div class="find-listinfo"><a href="http://beijing.lashou.com/deal/8791871.html?zf=1" target="_blank">去看看</a><span>¥75</span>市场价 ¥<del>100</del></div>
						</li>
					</ul>
					<div class="clr"></div>
				</div>
			...
			<div class="myls-right">
				...
				<div class="myls-rwarp">
					<a href="/event/lottery_form.php?act=user" target="_blank"><img src="http://img.test.lashou.com/static/img/myls/cj.png" height="97" width="236"></a>
					<span class="cj"></span>
				</div>
				<div class="myls-rwarp">
					<div class="myls-title">
					...
					<div class="myls-sctips">
						网站上收藏的团购商品在手机客户端上也同样可以找到哦，方便您到商家后找到团购项目。
						<a href="http://mobile.lashou.com/client_buy.html" target="_blank">下载手机客户端</a>
					</div>
				</div>
				<div class="myls-rwarp">
					<p class="towcode"><em>扫描二维码</em>直接下载安装可下载二维码扫描软件。
						<br><b>iphone</b>，<b>android</b> 均可</p>
					<img class="towcodeimg" src="http://img.test.lashou.com/static/img/imgextra/towcode.png" height="67" width="71">
					<div class="clr"></div>
				</div>
				<div class="myls-rwarp">
					<dl class="myls-rqa">
		...
		<script type="text/javascript">
			$(function() { //全选和反选
				$('#all_selector').click(function() {
					$('input[name=trade_no[]]:not(:disabled)').attr('checked', $(this).attr('checked'));
				})
				$('input[name=trade_no[]]:not(:disabled)').click(function() {
					var attr = true;
					$('input[name=trade_no[]]').each(function() {
						if (!$(this).attr('checked')) {
							attr = false;
						}
					})
					$('#all_selector').attr('checked', attr);
				})
				$("li.goods_list_hover").hover(function() {
					$(this).find('.com-place').addClass("place-hover");
				}, function() {
					$(this).find('.com-place').removeClass("place-hover");
				});
			});
			...
			function check() {
				...
				$('input[name="trade_no[]"]').each(function() {
					if ($(this).attr("checked") == true) {
						check_ids += $(this).val() + ","; //动态拼取选中的checkbox的值，用“,”符号分隔
					}
				});
				if (check_ids == "") {
					alert("请选择要删除的团购");
