			...
			<?php if(isset($_SESSION['cart'])){?>
				...
				<form id="sub_form" action="<?php echo U('Home/Trade/trade')?>" method="post" target="_self">
					<div class="cart-warp">
						...
						<input type="checkbox" name="infoIndex[]" class="checkboxs" value="<?php echo $k?>"/>
						<div class="cart-list cl">
							...
							<div class="quantity">
								<div class="quantity-number">
									...
									<input name="amount[]" class="shuliang" value="<?php echo $_SESSION['cart'][$k]['num']?>" type="text">
									<span class="plus">
										<i class="plus-icon">
										</i>
									</span>
							...
							<div class="price">
								<em>¥</em>
								<em class="totalprice"><?php echo $_SESSION['cart'][$k]['num']*$v['shopprice']?></em>
								<a href="<?php echo U('Home/ShoppingCart/delCart',array('index'=>$v['cartIndex']))?>">删除</a>
							</div>
						</div>
						<?php }?>
