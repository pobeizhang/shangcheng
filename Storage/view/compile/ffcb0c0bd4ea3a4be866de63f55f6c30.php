				...
				<div class="span12">
					...
					<table class="table table-bordered table-hover">
						...
						<tr class="info">
							<td>分类名称</td>
							<td>
								<input id="exampleInputEmail1" class="form-control" type="text" value='<?php echo $editdata['cname']?>' name="cname">
							</td>
						</tr>
						<tr>
							<td>分类排序</td>
							<td>
								<input id="exampleInputEmail1" class="form-control" type="number" value="<?php echo $editdata['sort']?>" name="sort" value="0">
