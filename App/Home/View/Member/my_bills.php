					...
					<div class="hdc">
						<div class="hdi">
							<div class="login">
								...
								<strong><a href="/account/orders/">{{$_SESSION['preusername']}}</a></strong>
								<div class="shopcart">
									<em class="text">
									<p class="fr">购物车(<b>{{if value="isset($_SESSION['cart'])"}}{{count($_SESSION['cart'])}}{{else}}0{{endif}}</b>)</p>
								<em class="sc-icon"></em>
									<i class="tri4"></i>
									</em>
								...
								<div class="myls">
									...
									<p>
										<a href="{{U('Home/Member/my_orders')}}">我的订单</a>
										<a href="{{U('Home/Member/my_collections')}}">我的收藏</a>
										<a href="">常用地址</a>
										<a href="{{U('Home/Member/my_bills')}}">拉手账本</a>
										<a href="">账户设置</a>
										<a href="">我的消息</a>
									</p>
								</div>
		...
		<div id="main">
			<div class="myls-left">
				<div class="myls-title">
					<a class="{{U('Home/Member/my_orders')}}">我的订单</a>
					<a href="{{U('Home/Member/my_collections')}}">我的收藏</a>
					<a class="select">拉手账本</a>
					<a href="{{U('Home/Member/my_setting')}}">账户设置</a>
					<a href="{{U('Home/Member/my_news')}}">我的消息</a>
				</div>
				<div class="myls-lc">
					<h3>
						<span class="fl">拉手账本</span>
						<ul class="fr">
							<li class="nobg selcet"><a href="javascript:;"><span>账户余额</span></a><em>{{$account}}</em></li>
					...
					<div class="myls-lct">
						...
						<table class="mytable2">
							<tbody>
								...
								<tr>
									<td><img src="{{$v['pic']}}" style="width: 80px" /></td>
									<td class="no-records" colspan="1">{{$v['oid']}}</td>
									<td class="no-records" colspan="1">{{$v['cname']}}</td>
									<td class="no-records" colspan="1">{{$v['quantity']}}</td>
									<td class="no-records" colspan="1">{{$v['subtotal']}}</td>
									<td class="no-records" colspan="1">{{date('Y-m-d H:i:s',$v['time'])}}</td>
								</tr>
								{{endforeach}}
							</tbody>
						</table>
			...
			<div class="myls-right">
				<div class="myls-rwarp myls-rwarptop">
					...
					<div class="myls-account">
						...
						<p>购买成功：<span>{{$numbers}}</span>份</p>
						<p class="line">总共节省：<span>¥&nbsp;0</span></p>
						<p><a href="/account/bills/">账户余额¥&nbsp;</a>：<span class='yue'>{{$account}}</span></p>
