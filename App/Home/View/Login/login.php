...
<body>
	...
	<div class='login-main'>
		<div class='login-left'>
			<img src="{{__PUBLIC__}}/Home/images/login02.png" alt="" />
		</div>
					...
					<form action="{{U('Home/Login/login')}}" method="post">
						...
						<li>
							<div class='input-warp'>
								...
								<img src="{{U('Home/Yzm/codeshow')}}" alt="验证码" width="74" height="36" class='yzmimg' />
						...
						<li class='link'>
							...
							<a href="{{U('Home/Register/register')}}" class='fr'>免费注册</a>
						</li>
					</form>
				</ul>
