...
<body>
	...
	<form action="{{U('Admin/Brand/editBrand')}}" method='post'>
		<fieldset>
		...
		<table class="table table-bordered table-hover">
			<tr class="info">
				<td>品牌名称</td>
				<td colspan="2">
					<input id="exampleInputEmail1" class="form-control" type="text" value="{{$editData['bname']}}" required="" name="bname">
				</td>
			</tr>
			<tr class="info">
				<td>品牌LOGO</td>
				<td>
					<img src="{{$editData['logo']}}" id="preview" alt="缩略图预览"/ width="50" height="50">
			...
			<tr class="info">
				<td>排序</td>
				<td colspan="2">
				<input id="exampleInputEmail1" class="form-control" type="number" required="" name="sort" value="{{$editData['sort']}}">
				</td>
			</tr>
			<tr>
