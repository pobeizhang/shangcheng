...
<body>
	<div id="top">
		拉手网&nbsp;&nbsp;商城
		<a href="{{U('Home/Index/index')}}" target="_blank">-商城首页-</a>
	</div>
	<div id="logbox">
		<img id="log" src="./Public/Admin/Images/welcome.png" alt="" />
		<form action="{{U('Admin/Login/login')}}" method="post">
			<input type="text" name="username" id="username" />
			<input type="password" name="password" id="password" />
			<img src="{{U('Admin/Login/verify')}}" alt="" id="code"/>
